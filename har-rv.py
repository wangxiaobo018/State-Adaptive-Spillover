...
#保存为csv文件
data_df.to_csv('har-rv-data.csv', index=False)
...
X_train = model_data[['rv_lag1', 'rv_lag5', 'rv_lag22']].iloc[:train_end]
X_test = model_data[['rv_lag1', 'rv_lag5', 'rv_lag22']].iloc[train_end:]
